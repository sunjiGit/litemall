...
public class RechargeConfigVo {
    ...
    private List<RechargeCouponVo> couponVos;
    ...
    public List<RechargeCouponVo> getCouponVos() {
        return couponVos;
    }

    public void setCouponVos(List<RechargeCouponVo> couponVos) {
    ...
    public boolean equals(Object o) {
        ...
        RechargeConfigVo that = (RechargeConfigVo) o;
